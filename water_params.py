...
class WaterParams(Resource):
    ...
    def post(self):
        ...
        parser.add_argument("conductivity_min", type=float, required=True)
        parser.add_argument("conductivity_max", type=float, required=True)
        parser.add_argument("bod_min", type=float, required=True)
        parser.add_argument("bod_max", type=float, required=True)
